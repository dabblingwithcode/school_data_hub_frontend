...
class MissedClass with _$MissedClass{
  ...
  MissedClass({required this.contacted, required this.createdBy, required this.missedDay, required this.missedPupilId, required this.missedType, required this.modifiedBy, required this.returned, required this.returnedAt, required this.writtenExcuse});
