...
class PupilBook with _$PupilBook{
    ...
    @JsonKey(name: 'lent_at') final  DateTime lentAt;
    @JsonKey(name: 'lent_by')final   String lentBy;
  ...
  PupilBook({ this.bookId,  this.lentAt,  this.lentBy,  this.pupilId,  this.receivedBy,  this.returnedAt,  this.state});
