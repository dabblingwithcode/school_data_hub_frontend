...
class CompetenceCheck with _$CompetenceCheck{
    @JsonKey(name: 'check_id') final String checkId;
    final String comment;
    @JsonKey(name: 'competence_id') final int competenceId;
    @JsonKey(name: 'competence_status') final int competenceStatus;
    @JsonKey(name: 'created_at') final DateTime createdAt;
    @JsonKey(name: 'created_by') final String createdBy;
    @JsonKey(name: 'pupil_id') final int pupilId;
    @JsonKey(name: 'is_report') final bool isReport;
  ...
  CompetenceCheck({required this.checkId, required this.comment, required this.competenceId, required this.competenceStatus, required this.createdAt, required this.createdBy, required this.pupilId, required this.isReport, required this.reportId, required this.competenceCheckFiles});
...
class CompetenceCheckFile  {
  ...
  CompetenceCheckFile({required this.checkId, required this.fileId, required this.fileUrl});
